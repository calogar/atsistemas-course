...
public class RentController {
	...
	public RentDTO create(@PathVariable("id") Integer idBook,
	...
	public void delete(@PathVariable("id") Integer idBook) {
	...
	public List<RentDTO> getBookHistory(@PathVariable("id") Integer idBook,
	...
	public List<RentDTO> getUserHistory(@PathVariable Integer idUser,
										@RequestParam(value = "page", required = false, defaultValue = "0") Integer page,
										@RequestParam(value = "size", required = false, defaultValue = "10") Integer size) {
